...
class ChatsRecyclerViewAdapter(
    ...
    private val listener : ItemViewClickListener,
    ...
    inner class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        private val displayPicture : ImageView = itemView.displayPicture
        val userName: TextView = itemView.userName
        val latestMessage: TextView = itemView.latestMessage
        ...
        private fun itemViewClickListener() {
            itemView.setOnClickListener {
                listener.onItemViewClickListener(itemView.userName.text.toString())
            }
        }
    }
    ...
    interface ItemViewClickListener {
        fun onItemViewClickListener(nameClicked : String)
    }
